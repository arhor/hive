...
public final class EspHomeMessageType {
    ...
    public static final int SUBSCRIBE_LOGS_REQUEST = 28;
    public static final int SUBSCRIBE_LOGS_RESPONSE = 29;
    ...
    public static final int SUBSCRIBE_HOMEASSISTANT_SERVICES_REQUEST = 34;
    public static final int HOMEASSISTANT_SERVICE_RESPONSE = 35;
    public static final int GET_TIME_REQUEST = 36;
    public static final int GET_TIME_RESPONSE = 37;
    public static final int SUBSCRIBE_HOME_ASSISTANT_STATES_REQUEST = 38;
    public static final int SUBSCRIBE_HOME_ASSISTANT_STATE_RESPONSE = 39;
    public static final int HOME_ASSISTANT_STATE_RESPONSE = 40;
    public static final int LIST_ENTITIES_SERVICES_RESPONSE = 41;
    public static final int EXECUTE_SERVICE_REQUEST = 42;
    ...
    public static final int SIREN_COMMAND_REQUEST = 57;
    ...
    public static final int MEDIA_PLAYER_COMMAND_REQUEST = 65;
    ...
    public static final int VALVE_COMMAND_REQUEST = 111;
    public static final int LIST_ENTITIES_DATETIME_RESPONSE = 112;
    public static final int DATETIME_STATE_RESPONSE = 113;
    public static final int DATETIME_COMMAND_REQUEST = 114;
    public static final int LIST_ENTITIES_UPDATE_RESPONSE = 116;
    public static final int UPDATE_STATE_RESPONSE = 117;
    public static final int UPDATE_COMMAND_REQUEST = 118;
    public static final int NOISE_ENCRYPTION_SET_KEY_REQUEST = 124;
    public static final int NOISE_ENCRYPTION_SET_KEY_RESPONSE = 125;
